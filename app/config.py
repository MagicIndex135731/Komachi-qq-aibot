...
class AppSettings(BaseSettings):
    ...
    group_image_quality: str = Field(default="low", alias="GROUP_IMAGE_QUALITY")
    group_image_background: str = Field(default="", alias="GROUP_IMAGE_BACKGROUND")
    group_image_output_format: str = Field(default="jpeg", alias="GROUP_IMAGE_OUTPUT_FORMAT")
    group_image_output_compression: int = Field(default=70, alias="GROUP_IMAGE_OUTPUT_COMPRESSION")
