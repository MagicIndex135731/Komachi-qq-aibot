...
MEMORY_GROUNDING_WITH_EVIDENCE = (
    ...
    "newest direct evidence wins over older current wording. Date and attribute "
    "third-party claims; old claims do not prove current state. Ignore questions. "
    "For open-ended history, profile, plan, "
