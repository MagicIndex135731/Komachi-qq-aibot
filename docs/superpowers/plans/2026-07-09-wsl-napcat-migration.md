...
git grep -n "sk-|OPENAI_API_KEY|API_KEY|Authorization|Bearer|200000006|200000003" -- .
```
...
def test_wsl_env_example_has_no_real_secrets() -> None:
    ...
    forbidden = ["sk-", "Bearer ", "OPENAI_API_KEY=", "200000006", "200000003"]
...
```powershell
git status --short
git grep -n "sk-|OPENAI_API_KEY=sk-|Authorization: Bearer|200000006|200000003" -- .
```
