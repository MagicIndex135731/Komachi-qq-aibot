...
- [ ] After the user completes QQ login, verify `CheckLoginStatus.isLogin=true`, OneBot `online=true`, `get_login_info` is account `200000003`, and `get_group_list(no_cache=true)` succeeds.
